# Generated by Django 3.2 on 2023-09-04 13:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Name the category', max_length=256)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(auto_now_add=True, verbose_name='Date of publication')),
                ('text', models.TextField()),
                ('score', models.PositiveSmallIntegerField(help_text='Choose the number between 1 and 10', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10)])),
            ],
            options={
                'verbose_name': 'review',
